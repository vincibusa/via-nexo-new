...
export default function EditDiscoveryPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.ok) {
        toast.success('Contenuto Discovery aggiornato con successo')
        router.push('/admin/discovery')
      } else {
        const error = await response.json()
      ...
      <ProtectedRoute requiredRole="admin">
        <div className="space-y-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold">Modifica Contenuto Discovery</h1>
            </div>
          </div>
          <Card>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm sm:text-base text-muted-foreground">
                Modifica un contenuto del feed Discovery
              </p>
            </div>
          </div>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Numeri più alti appaiono per primi.
              </p>
            </div>
